    ...
    this.evercookie_silverlight = function (name, value) {
      ...
      var source = _ec_baseurl + "evercookie.xap",
	    ...
	    params = {
		    ...
		    windowless: "true",
		    minRuntimeVersion: minver,
		    autoUpgrade: false
	    };
      if (value !== undefined) {
	    params["initParams"] = name + '=' + value;
      }
      element = document.createElement("object");
	  element.setAttribute("style", "position:absolute;left:-500px;top:-500px");
	  element.setAttribute("data", "data:application/x-silverlight-2");
	  element.setAttribute("type", "application/x-silverlight-2");
	  element.setAttribute("id", "mysilverlight");
	  ...
	  link.setAttribute("href", "http://go.microsoft.com/fwlink/?LinkID=149156&v=" + minver)
	  link.setAttribute("style", "display: none");
	  link.innerHTML = "Get Microsoft Silverlight";
